...
public enum PacketOperations {
    ...
    S2CMatchplayEndBasicGame(0x26FC),
    C2SClubMatchReady(0x26F7),
    S2CClubMatchReady(0x26F8),
    C2SClubMatchStart(0x26F9),
    S2CClubMatchGameTime(0x26FA),
    ...
    CMSG_ThrowBait(0x2BC5),
    SMSG_ThrowBait(0x2BC6),
    S2CFishingBar(0x2B74),
    CMSG_ReturnBait(0x2BCC),
    SMSG_ReturnBait(0x2B75),
    CMSG_SetBaitLocation(0x2BC8),
    SMSG_SetBaitLocation(0x2BC9),
    CMSG_FishingEnd(0x2BDA),
    ...
    C2SRelayNetErr(0x0401),
    C2SRelayNetErr2(0x0405),
    C2SMatchplaySkillExtra(0x0C95),
    C2SPlayerListExtra(0x1007),
    C2SRoomPlayerExtra(0x13A6),
    C2SClient1451(0x1451),
    C2SClient1453(0x1453),
    C2SClient1454(0x1454),
    C2SLobbyExtra170D(0x170D),
    C2SLobbyExtra170F(0x170F),
    C2SLobbyExtra1711(0x1711),
    C2SUnsetHostFollowup(0x17D7),
    C2SSetHostFollowup(0x17DB),
    C2SStartGameAck(0x17E9),
    C2SStartGameCancel(0x17F2),
    C2SMatchplayExtra1850(0x1850),
    C2SChatSquareExtra(0x18A4),
    C2SChatHouseExtra(0x18A7),
    C2SRoomExtra18AE(0x18AE),
    C2SRoomExtra18B0(0x18B0),
    C2SRoomGameModeExtra(0x18B1),
    C2SInventoryExtra(0x1B77),
    C2SInventorySellExtra(0x1D0B),
    C2SBettingStart(0x1DB0),
    C2SBettingStart2(0x1DB2),
    C2SExpandCardSlotReq(0x1DE3),
    C2SFriendExtra(0x1F58),
    C2SGuildChatExtra(0x2033),
    C2SGuildSearchExtra(0x2038),
    C2SGuildReverseExtra(0x203E),
    C2SCouponExtra(0x213E),
    C2SCouponExtra2(0x213F),
    C2SEmoteOrMotion(0x2288),
    C2SLobbyState(0x237B),
    C2SShopExtra(0x238E),
    C2SShopExtra2(0x238F),
    C2SClient23F2(0x23F2),
    C2SClient23F4(0x23F4),
    C2SClient240E(0x240E),
    C2SReadyWaitTime(0x2411),
    C2SClient2416(0x2416),
    C2SProposalListExtra(0x2528),
    C2STownExtra2648(0x2648),
    C2STownExtra264A(0x264A),
    C2STownExtra264C(0x264C),
    C2STownExtra2650(0x2650),
    C2STournamentListExtra(0x26B1),
    C2STournamentJoinExtra(0x26B3),
    C2STournamentApplyDouble(0x26B5),
    C2STournamentCancelDouble(0x26B7),
    C2STournamentExtra26BE(0x26BE),
    C2SGmSpectator(0x26C0),
    C2STournamentExtra26C2(0x26C2),
    C2STournamentApplySingle(0x26C6),
    C2SLeagueGuildTeamBattle(0x26C8),
    C2SClient26DF(0x26DF),
    C2SClubMatchExtra(0x26F2),
    C2SClubMatchWarfareExtra(0x2702),
    C2SClubMatchExtra270F(0x270F),
    C2SClient2EE2(0x2EE2),
    C2CRelayObjectType7(0x32CB),
    C2CCrystalExtra(0x3330),
    C2CSpiderMineExtra3392(0x3392),
    C2CSpiderMineExtra3393(0x3393),
    C2CSpiderMineExtra3394(0x3394),
    C2CSpiderMineExtra3395(0x3395),
    C2CSpiderMineExtra3396(0x3396),
    C2CSpiderMineExtra33A4(0x33A4),
